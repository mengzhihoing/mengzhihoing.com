...
#bin下载地址
BIN=http://soft.91yun.org/soft/serverspeeder/bin/CentOS/6.7/2.6.32-042stab112.15/x64/3.10.61.0/serverspeeder_3161
...
rv=CentOS_6.7_2.6.32-042stab112.15
...
echo "开始下载bin运行文件。。。。"
echo "======================================"
curl $BIN -o 91yunserverspeeder/apxfiles/bin/acce-3.10.61.0-[CentOS_6.7_2.6.32-042stab112.15] || { echo "下载bin运行文件失败，请检查";exit 1; }
